      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <ul class="menus">
             <?php
              ...
              <li>
                <figure class="image"><img src="img/hamb4.jpg" alt="Free Bootstrap Template by uicookies.com"></figure>
                <div class="text">
                  <span class="price">$22.99</span>
          ...
          <div class="col-md-6">
            <ul class="menus">
              <li>
                <figure class="image"><img src="img/hamb5.jpg" alt="Free Bootstrap Template by uicookies.com"></figure>
                <div class="text">
                  <span class="price">$22.99</span>
