...
<section class="probootstrap-section-bg overlay" style="background-image: url(../application/resources/img/hero_bg_1.jpg); height: 250px;">
     ...
     <div class="container">
		...
		<h4>Deliverys esperando aprobación: </h4>
				...
				echo"</div> <br>";
					...
					echo "<a class='probootstrap-custom-link' href='/AdministradorDeSistema/habilitarDelivery?idUsuario=".$idUsuario."'>Habilitar</a>
					<a class='probootstrap-custom-link' href='/AdministradorDeSistema/eliminarDelivery?idUsuario=".$idUsuario."'>Eliminar</a> <br>"; 
