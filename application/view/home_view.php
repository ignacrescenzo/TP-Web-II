...
//$result= mysqli_query($conexion,$sql);
  ?>
    ...
    <section class="flexslider" data-section="welcome">
        <ul class="slides">
            <li style="background-image: url(../application/resources/img/hero_bg_1.jpg)" class="overlay"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 text-center probootstrap-animate">
                    ...
                    <p>RESTÓ te permite pedir comida a domicilio a miles de restaurantes y millones de platos en tu
                        ubicación. ¿Se te antoja una gran pizza? ¿Un delicioso sushi? ¿Una jugosa hamburguesa? ¿Unas
                        ricas empanadas? ¿O una sabrosa comida vegetariana? <br>Con unos simples pasos puedes recibir
                        en tu puerta tu comida favorita.</p>
                    <p><a href="#" class="probootstrap-custom-link">Saber más</a></p>
                </div>
                <div class="col-md-6 col-md-push-1 probootstrap-animate">
                    <p><img src="../application/resources/img/comida.jpg" alt="Free Bootstrap Template by uicookies.com"
