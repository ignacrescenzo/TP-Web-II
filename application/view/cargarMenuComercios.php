...
<html lang="en">
  <head>
    ...
    <title>Restó | Cargar menús</title>
      ...
      <div class="container">
        ...
        <div class="col-md-12 text-center probootstrap-animate">
            <div class="probootstrap-heading"> <br><br><br><br><br>
              <h5 class="secondary-heading" style="color: black; font-size: 20px;">Ingresa los datos del nuevo menú:</h5>
            </div>
          </div>

             <form method="POST" action="../menu/nuevo" enctype="multipart/form-data">
              ...
              <div class="form-group">
              <div class="form-field">
                  <input type="submit" name="submit" id="submit" value="Cargar" class="btn btn-lg btn-primary btn-block">
                </div>
              </div>
